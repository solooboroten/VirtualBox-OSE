...
HWACCMR0DECL(int) SVMR0LoadGuestState(PVM pVM, CPUMCTX *pCtx)
{
    ...
    if (pCtx->msrEFER & MSR_K6_EFER_LMA)
    {
        ...
        pVMCB->guest.FS.u64Base    = pCtx->fsHid.u32Base;
        pVMCB->guest.GS.u64Base    = pCtx->gsHid.u32Base;
    }
    else
    {
