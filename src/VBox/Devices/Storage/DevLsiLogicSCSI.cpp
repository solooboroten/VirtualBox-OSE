                                                            ...
                                                            int rcCompletion, bool fRedo, int rcReq)
{
    ...
    if (fRedo)
    {
        ...
        do
        {
            pTaskState->pRedoNext = (PLSILOGICTASKSTATE)ASMAtomicReadPtr((void * volatile *)&pLsiLogic->pTasksRedoHead);
        } while (!ASMAtomicCmpXchgPtr((void * volatile *)&pLsiLogic->pTasksRedoHead, pTaskState, pTaskState->pRedoNext));
