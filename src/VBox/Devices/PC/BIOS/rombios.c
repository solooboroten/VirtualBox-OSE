...
#ifdef VBOX
static char drivetypes[][10]={"Floppy","Hard Disk","CD-ROM","LAN"};
#else /* !VBOX */
...
#ifdef VBOX
void
print_boot_device(cdboot, lanboot, drive)
  Bit8u cdboot; Bit8u lanboot; Bit16u drive;
#else /* !VBOX */
void
...
#ifdef VBOX
  void
print_boot_failure(cdboot, lanboot, drive, reason, lastdrive)
  Bit8u cdboot; Bit8u lanboot; Bit8u drive; Bit8u reason; Bit8u lastdrive;
#else /* !VBOX */
  void
...
pci_routing_table_structure_start:
  ...
  db 0 ;; pci bus number
  db 0x40 ;; pci device number (bit 7-3)
  db 0x63 ;; link value INTA#
  dw 0xdef8 ;; IRQ bitmap INTA#
  db 0x60 ;; link value INTB#
  dw 0xdef8 ;; IRQ bitmap INTB#
  ...
  db 0 ;; pci bus number
  db 0x48 ;; pci device number (bit 7-3)
  db 0x60 ;; link value INTA#
  dw 0xdef8 ;; IRQ bitmap INTA#
  db 0x61 ;; link value INTB#
  dw 0xdef8 ;; IRQ bitmap INTB#
  ...
  db 0 ;; pci bus number
  db 0x50 ;; pci device number (bit 7-3)
  db 0x61 ;; link value INTA#
  dw 0xdef8 ;; IRQ bitmap INTA#
  db 0x62 ;; link value INTB#
  dw 0xdef8 ;; IRQ bitmap INTB#
