...
struct VBOXLACONTEXT
{
    ...
    RTLISTNODE listAttachActions;
    RTLISTNODE listDetachActions;
...
static void ActionExecutorDeleteActions(RTLISTNODE *listActions)
{
...
static void ActionExecutorExecuteActions(RTLISTNODE *listActions)
{
